...
export const defaultZap = { "amount": 42, "message": "Haladjunk együtt! 🫡" };

export const defaultZapOptions = [
  { emoji: '👍', amount: 21, message: 'Klasz bejegyzés! 👍' },
  { emoji: '🚀', amount: 420, message: 'Na, szurkolok neked! 🚀' },
  { emoji: '☕', amount: 1_000, message: 'Ez megér egy kávét! ☕' },
  { emoji: '🍻', amount: 5_000, message: 'Egészségedre! 🍻' },
  { emoji: '🍷', amount: 10_000, message: 'Ez csúcs! 🍷🍷' },
  { emoji: '👑', amount: 100_000, message: 'Gyarapodj, sokasodj! 👑' },
];
